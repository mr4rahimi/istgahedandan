...
const NAV = [
  ...
  { href: "/dentist/appointments", label: "نوبت‌ها", icon: "M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" },
  { href: "/dentist/schedule", label: "برنامه نوبت‌دهی", icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" },
